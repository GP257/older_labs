...
void timer::print() const{
  ...
  if(_opsSet){
    ...
    std::cerr<<_name<<std::string(" totTime=")<<std::to_string(static_cast<long long>(_totTime.count()))<<std::string(" calls=")<<std::to_string(static_cast<long long>(_ncalls))<<std::string(" Mcells/Sec=")<<std::to_string(static_cast<long double>(speed))<<std::endl;
